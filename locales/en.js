...
window.LOCALES['en-US'] = {
  ...
  'aiExport.flowHint': 'Suggested flow: download the 6-grid PNG → upload it to Gemini as a reference image → paste the Prompt (or JSON Prompt) → paste the Negative Prompt → generate.',
};
